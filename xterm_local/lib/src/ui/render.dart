...
class RenderTerminal extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  ...
  void selectWord(CellOffset fromOffset, [CellOffset? toOffset]) {
  ...
  /// Selects characters in the terminal that starts from [fromPosition] to [toPosition]. At
  /// least one cell is selected even if [fromPosition] and [toPosition] are same.
  void selectCharacters(CellOffset fromPosition, [CellOffset? toPosition]) {
    if (toPosition == null) {
      _controller.setSelection(
