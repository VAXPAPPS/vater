...
class _TerminalGestureHandlerState extends State<TerminalGestureHandler> {
  ...
  void onDoubleTapDown(TapDownDetails details) {
    renderTerminal.selectWord(renderTerminal.getCellOffset(details.localPosition));
  }

  void onLongPressStart(LongPressStartDetails details) {
    _longPressStartCellOffset = renderTerminal.getCellOffset(details.localPosition);
    renderTerminal.selectWord(_longPressStartCellOffset!);
  }

  void onLongPressMoveUpdate(LongPressMoveUpdateDetails details) {
    if (_longPressStartCellOffset != null) {
  ...
  void onDragStart(DragStartDetails details) {
    ...
    details.kind == PointerDeviceKind.mouse
        ? renderTerminal.selectCharacters(_dragStartCellOffset!)
        : renderTerminal.selectWord(_dragStartCellOffset!);
  }

  void onDragUpdate(DragUpdateDetails details) {
    if (_dragStartCellOffset != null) {
      _lastDragStartDetails!.kind == PointerDeviceKind.mouse
